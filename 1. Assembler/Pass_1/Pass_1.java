...
class MnemonicTable {
    ...
    public MnemonicTable(String mnemonic, String opcode) {
...
public class Pass_1 {
    ...
    public void createIS() {
        String[][] mnemonics = { { "STOP", "00" }, { "ADD", "01" }, { "SUB", "02" }, { "MULT", "03" },
                { "MOVER", "04" }, { "MOVEM", "05" }, { "COMP", "06" }, { "BC", "07" }, { "DIV", "08" },
                { "READ", "09" }, { "PRINT", "10" } };
        for (String[] mnemonic : mnemonics) {
            is.put(mnemonic[0], new MnemonicTable(mnemonic[0], mnemonic[1]));
        }
    }
